package com.hyh.aspectjpermission.advise;
...
import com.hyh.aspectjpermission.annotation.Permission;
...
public class AdvisePermission implements IAspectj {
    @Around("execution(@com.xdja.aspectjpermission.annotation.Permission * *(..)) && @annotation(annot)")
    public Object weavePermission(ProceedingJoinPoint joinPoint, Permission annot) throws Throwable {
